...
//firebase is serverless, kan n backend gee met hierdie JS wat geskryf word. Hierdie is basies die "backend"
...
exports.getEvent = functions.https.onRequest(async (req, res) => {
    ...
    key = '0d7764cec6ff4982b6257b85ab293701'
    eventId = req.body; //set req(soos die promise), soek body van die request. dan event id na hierdie om hier onder te gebruik
    try {
